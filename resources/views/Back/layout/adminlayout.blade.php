...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        @include('Back.layout.navbar') <!-- Navbar will be injected here -->
        @include('Back.layout.sidenav') <!-- Sidebar will be injected hereBack
        ...
        @include('Back.layout.footer') <!-- Footer will be injected here -->
