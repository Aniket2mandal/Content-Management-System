...
<div class="col-md mt-4">
    ...
    <div class="card card-primary  mb-4">
        ...
        <!--end::Header-->
        <!--begin::Form-->
        <form id="AuthorForm" action="{{ route('author.update',$author->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <!--begin::Body-->
            <div class="card-body">
                ...
                <input type="checkbox" name="Status" id="Status" data-toggle="toggle" data-on="Active" data-off="Inactive" data-onstyle="success" data-offstyle="danger" value="1" {{ old('Status',$author->Status) ? 'checked' : '' }}>
